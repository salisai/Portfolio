      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-20">
        ...
        <div className="max-w-4xl">
          <motion.div
            ...
            whileInView="show"
            viewport={{ once: true }}
            className="grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-8 md:gap-2 mb-16 items-stretch"
          >
            {/* Contact Info */}
            <motion.div
              variants={revealSoft}
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <Input
                      ...
                      required
                      className=" border z-20 border-dashed border-primary/10 text-sm placeholder:text-muted-foreground"
                    />
                    <Input
                  ...
                  <Textarea
                    ...
                    required
                    className="
                    z-20 border border-dashed border-primary/10
                    text-sm
